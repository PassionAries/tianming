// @ts-check
// Generated mechanically from the former validators classic-script fragment.
// The functions remain behavior-identical; dependencies now arrive through the factory.
export function createValidators(deps) {
  ...
  return {
    _validatePersonnelConsistency: _validatePersonnelConsistency,
    _validateMilitaryConsistency: _validateMilitaryConsistency,
    _validateSentimentConsistency: _validateSentimentConsistency,
    _validatePopulationConsistency: _validatePopulationConsistency,
    _validateOfficeConsistency: _validateOfficeConsistency,
    _validateWarConsistency: _validateWarConsistency,
    _validateRevoltConsistency: _validateRevoltConsistency,
    _validateDisasterConsistency: _validateDisasterConsistency,
    _validateDiplomacyConsistency: _validateDiplomacyConsistency,
    _validateKejuConsistency: _validateKejuConsistency,
    _validatePartyConsistency: _validatePartyConsistency,
    _validateEdictEffectConsistency: _validateEdictEffectConsistency,
    _validateCourtCeremonyConsistency: _validateCourtCeremonyConsistency,
    _validateConstructionConsistency: _validateConstructionConsistency,
    _validateMarriageBirthConsistency: _validateMarriageBirthConsistency,
    _validateConspiracyConsistency: _validateConspiracyConsistency,
    _validateCurrencyConsistency: _validateCurrencyConsistency,
    _validateReligionConsistency: _validateReligionConsistency,
    _validateOmenConsistency: _validateOmenConsistency,
    _validateFiscalConsistency: _validateFiscalConsistency,
    _maybeReconcileWithAI: _maybeReconcileWithAI,
    _narrativeDeathSourced: _narrativeDeathSourced,
    _textMentionsName: _textMentionsName,
    _classifyStructuredDeathKind: _classifyStructuredDeathKind,
    _writeActionSourced: _writeActionSourced,
    _gateJudicialPersonnelChange: _gateJudicialPersonnelChange,
    _sensitiveCharFieldSourced: _sensitiveCharFieldSourced,
    _gateEventTimepoint: _gateEventTimepoint,
    _gateAllegianceSource: _gateAllegianceSource,
    _gateDeathRoutingSource: _gateDeathRoutingSource,
    _wgCachedAllNames: _wgCachedAllNames,
    _wgCachedCourtText: _wgCachedCourtText
  };
}
