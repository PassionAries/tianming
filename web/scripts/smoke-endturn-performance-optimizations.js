...
const applySrc = read('tm-endturn-apply.js') + '\n' + read('tm-endturn-apply-stages.js'); // apply解构S2·reconcile 等 stage 迁 stages·拼接 origin→stages 保断言可见
...
const kejuRuntimeSrc = (read('tm-keju-runtime.js') + read('tm-keju-runtime-keyi.js'));
