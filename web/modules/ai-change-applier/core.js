...
export function createCore(deps) {
  ...
  function _captureValidatorBaseline(G){ return _modules.reconcile._captureValidatorBaseline.apply(this, arguments); }
  function _collectValidatorFailures(G, baseline){ return _modules.reconcile._collectValidatorFailures.apply(this, arguments); }
  function _runConsistencyValidator(applied, aiOutput, name, fn){ return _modules.reconcile._runConsistencyValidator.apply(this, arguments); }
  ...
  function _applyAITurnChangesUnsafe(aiOutput) {
    ...
    (aiOutput.allegiance_changes || aiOutput.allegianceChanges || aiOutput.defections || []).forEach(function(a) {
      ...
      var _wgAl = _modules.validators; var r = (_wgAl && _wgAl._gateAllegianceSource && _wgAl._gateAllegianceSource(G, aiOutput, charRef, newFac, a.reason || a.cause || '', applied)) ? { ok: false, reason: 'no-source-faction(write-gate)' } : applyAllegianceChange(G, charRef, newFac, { reason: a.reason || a.cause || '', type: a.type || a.kind || a.mode || '' });   // 刀C·返工issue5·改换门庭判源
    ...
    (aiOutput.events || []).forEach(function(e) {
      var _c4b = _modules.validators; if (_c4b && _c4b._gateEventTimepoint && _c4b._gateEventTimepoint(G, e, applied)) return;   // 刀C·C4·events 时点闸(逻辑在 validators·未来年份硬拒/未到期史实软提示)
  ...
  // 经共享 module factory dependencies 双向接线：本片装载末尾把 kept 成员导出 bucket 供分片闭包捕获；
  ...
  function _validatePersonnelConsistency(G, aiOutput, applied){ return _modules.validators._validatePersonnelConsistency.apply(this, arguments); }
  function _validateMilitaryConsistency(G, aiOutput, applied){ return _modules.validators._validateMilitaryConsistency.apply(this, arguments); }
  function _validateSentimentConsistency(G, aiOutput, applied){ return _modules.validators._validateSentimentConsistency.apply(this, arguments); }
  function _validatePopulationConsistency(G, aiOutput, applied){ return _modules.validators._validatePopulationConsistency.apply(this, arguments); }
  function _validateOfficeConsistency(G, aiOutput, applied){ return _modules.validators._validateOfficeConsistency.apply(this, arguments); }
  function _validateWarConsistency(G, aiOutput, applied){ return _modules.validators._validateWarConsistency.apply(this, arguments); }
  function _validateRevoltConsistency(G, aiOutput, applied){ return _modules.validators._validateRevoltConsistency.apply(this, arguments); }
  function _validateDisasterConsistency(G, aiOutput, applied){ return _modules.validators._validateDisasterConsistency.apply(this, arguments); }
  function _validateDiplomacyConsistency(G, aiOutput, applied){ return _modules.validators._validateDiplomacyConsistency.apply(this, arguments); }
  function _validateKejuConsistency(G, aiOutput, applied){ return _modules.validators._validateKejuConsistency.apply(this, arguments); }
  function _validatePartyConsistency(G, aiOutput, applied){ return _modules.validators._validatePartyConsistency.apply(this, arguments); }
  function _validateEdictEffectConsistency(G, aiOutput, applied){ return _modules.validators._validateEdictEffectConsistency.apply(this, arguments); }
  function _validateCourtCeremonyConsistency(G, aiOutput, applied){ return _modules.validators._validateCourtCeremonyConsistency.apply(this, arguments); }
  function _validateConstructionConsistency(G, aiOutput, applied){ return _modules.validators._validateConstructionConsistency.apply(this, arguments); }
  function _validateMarriageBirthConsistency(G, aiOutput, applied){ return _modules.validators._validateMarriageBirthConsistency.apply(this, arguments); }
  function _validateConspiracyConsistency(G, aiOutput, applied){ return _modules.validators._validateConspiracyConsistency.apply(this, arguments); }
  function _validateCurrencyConsistency(G, aiOutput, applied){ return _modules.validators._validateCurrencyConsistency.apply(this, arguments); }
  function _validateReligionConsistency(G, aiOutput, applied){ return _modules.validators._validateReligionConsistency.apply(this, arguments); }
  function _validateOmenConsistency(G, aiOutput, applied){ return _modules.validators._validateOmenConsistency.apply(this, arguments); }
  function _validateFiscalConsistency(G, aiOutput, applied){ return _modules.validators._validateFiscalConsistency.apply(this, arguments); }
  function _maybeReconcileWithAI(G, aiOutput, applied){ return _modules.validators._maybeReconcileWithAI.apply(this, arguments); }
  // — 复核/善后族（迁出 tm-ai-change-applier-reconcile.js）—
  function _processDeathEpitaphs(G, aiOutput){ return _modules.reconcile._processDeathEpitaphs.apply(this, arguments); }
  function _reconcilePlayerMovements(G){ return _modules.reconcile._reconcilePlayerMovements.apply(this, arguments); }
  function _reconcilePlayerFiscalReforms(G, aiOutput){ return _modules.reconcile._reconcilePlayerFiscalReforms.apply(this, arguments); }
  function _applyOfficeDutyTick(G){ return _modules.reconcile._applyOfficeDutyTick.apply(this, arguments); }
  function _applyTaxAuthorityGate(G, fa, amount){ return _modules.reconcile._applyTaxAuthorityGate.apply(this, arguments); }
  function _applyDirectiveCompliance(G, aiOutput){ return _modules.reconcile._applyDirectiveCompliance.apply(this, arguments); }
  function _applyRegentDecisions(G, aiOutput){ return _modules.reconcile._applyRegentDecisions.apply(this, arguments); }
  function preflightAIWriteBack(aiOutput, opts){ return _modules.reconcile.preflightAIWriteBack.apply(this, arguments); }
  function _applyBattleResult(G, aiOutput, applied){ return _modules.reconcile._applyBattleResult.apply(this, arguments); }
  function _applyFiscalDeficitPenalties(G){ return _modules.reconcile._applyFiscalDeficitPenalties.apply(this, arguments); }
  function _hasInstantArrivalRule(G){ return _modules.reconcile._hasInstantArrivalRule.apply(this, arguments); }
  ...
  return {
    ...
    internals: {
      ...
      _estimateTravelDays: _estimateTravelDays,
      _arriveCharNow: _arriveCharNow,
      _sameTravelLocation: _sameTravelLocation,
      _travelMirrorFields: _travelMirrorFields,
      _syncCharacterLocationMirrors: _syncCharacterLocationMirrors,
      _refreshCharacterLocationUiAfterTravel: _refreshCharacterLocationUiAfterTravel,
      _applyAITurnChangesUnsafe: _applyAITurnChangesUnsafe
    }
  };
}
