...
(function () {
  ...
  //   刀C·C1(2026-07-19)后：结构化裸病笃/薨逝若无源亦被 preflight 拦(见 smoke-write-gate-expansion)；本例意在校验 handled/墓志铭
  //   机制(与 sourcing 正交)·故给玩家诏令留意(有源·同本文件 line167 范式)令 C1 放行·机制照测。
  const ctx = makeCtx();
  ctx.GM = { turn: 5, facs: [{ name: '明朝廷' }], officeTree: [], _turnReport: [], publicTreasury: {},
    guoku: { money: 100000 }, neitang: { money: 50000 },
    _playerDirectives: [{ id: 'd1', content: '密切留意老臣魏忠贤动向' }],
