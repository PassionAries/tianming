...
(function (global) {
  function agentFlagOn(name) {
    try {
      ...
      if ((name === 'factionAgentEnabled' || name === 'factionGoalStackEnabled') && global.GM && global.GM._factionLivingWorld !== false) return true;   // 2026-07-22 翻默认 ON·可关(显式 false 才关·仍在 agent-mode 互斥闸之后·B8 不变)
